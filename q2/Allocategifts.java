/**
* This class allocates gifts to the girls, it receives couples
* array and gifts array as argument and sets couples array's attributes 
* while allocating gift to girls
*
* @author  Anurag Kumar 
*/
